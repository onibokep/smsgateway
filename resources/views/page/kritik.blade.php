        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="min-height:450px;">
                    ...
                    <div>
                        <table class="table table-striped" id="kritik-tb" cellspacing="0" width="100%">
                            <thead>
                            <tr>
                            ...
                            @foreach($box as $inbox)
                                <tr class="item{{ $inbox->ID }}">
                                    <td>{{ $inbox->ReceivingDateTime }}</td>
                                    <td>{{ $inbox->SenderNumber }}</td>
                                    <td>{{ $inbox->TextDecoded }}</td>
                                    <td><a data-id="{{ $inbox->ID }}" data-nope="{{ $inbox->SenderNumber }}" data-toggle="tooltip" data-title="Hapus" class="btn-hapus"><i class="fa fa-trash"></i> </a></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
