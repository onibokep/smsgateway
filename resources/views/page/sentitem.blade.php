        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="min-height:450px;">
                    ...
                    <div>
                        <table class="table table-striped" id="sentitems-tb">
                            <thead>
                            <tr>
                            ...
                            @foreach($items as $d)
                                <tr class="item{{ $d->ID }}">
                                    ...
                                    <td>{{ $d->name }}</td>
                                    <td>
                                        <a class="btn-hapus" id="hapus-outbox" data-id="{{ $d->ID }}" data-nope="{{ $d->DestinationNumber }}" data-toggle="tooltip" data-title="Hapus"><i class="fa fa-trash"></i> </a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
