        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" style="min-height:450px;">
                    <div class="x_title">
                        <h2>Periode Laporan Kritik dan Saran</h2>
                        <div class="clearfix"></div>
                    </div>
                    <div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Preview Data Kritik dan Saran</h4>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        $('#laporan-surat').on('show.bs.modal', function () {
            $('#tgl1').val('');
            $('#tgl2').val('');
            $('.surat').html('<iframe src="{{ route('data-ks') }}" width="100%" height="470px"></iframe>');
        });
    });
</script>
@endpush